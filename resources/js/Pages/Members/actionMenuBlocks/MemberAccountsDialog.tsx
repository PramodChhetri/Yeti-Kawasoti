...
export function MemberAccountsDialog({
    member,
    open,
    onClose,
}: {
        ...
        return (
            <Dialog>
                <DialogTrigger asChild>
                    <Button variant="default" className="w-fit ms-auto">
                        Add Transaction
                    </Button>
                </DialogTrigger>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Enter the miscellaneous transaction details for{" "}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            {/* Conditional Fields */}
                            {data.transaction_type !== "credit-payment" &&
                            ...
                            {data.transaction_type === "refund" && (
                                <div className="col-span-full">
                                    ...
                                    />
                                    <InputError
                                        message={errors.payment_voucher}
                                    />
                                </div>
                            )}
                        </div>
        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-[1600px] w-[95vw] max-h-[99vh] overflow-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Efficiently analyze the payments of a member.
                    </DialogDescription>
                </DialogHeader>
                <div className="grid grid-cols-3 gap-2">
                    ...
                    <Card
                        className={
                            member.credit > 0 ? "bg-red-500" : "bg-green-500"
                        }
                    >
                        <CardHeader>
                            <CardTitle className={"text-white"}>
                                Rs {Math.abs(Number(member.credit))}
                            </CardTitle>
                            <CardDescription className="text-white/80">
                                Total{" "}
                        ...
                        <Table className="text-center">
                            ...
                            <TableBody>
                                {ledger.map((l: any) => {
                                    ...
                                    const dueAmount = l.paid_amount
                                        ? Number(l.net_amount - l.paid_amount)
                                        : Number(l.net_amount);
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                {l.payment_proof ? (
                                                    <a
                                                        href={l.payment_proof}
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="text-gray-500 underline hover:text-purple-700"
                                                    >
                                                        View
                                                    </a>
                                                ) : (
